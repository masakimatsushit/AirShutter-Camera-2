...
struct widget2LiveActivity_Previews: PreviewProvider {
    static let attributes = widget2Attributes(name: "Me")
    static let contentState = widget2Attributes.ContentState(value: 3)
